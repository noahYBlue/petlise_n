  ...
  <div class="containers">
    <div class="contents">
      ...
      <div class="detail_info">
        <div class="detail_writer">작성자 : ${noticeInfo.name}</div>
        <div style="padding-right: 50px;" class="detail_date"><fmt:formatDate value="${noticeInfo.notice_created}" pattern="yyyy-MM-dd H:mm" /></div>
        <div class="detail_view"  style="padding-right: 50px;">조회수 ${noticeInfo.view_count} </div>
      </div>
